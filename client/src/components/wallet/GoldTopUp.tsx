...
import { Coins, Gift, Loader2, ArrowRight } from 'lucide-react';
...
import { PaymentMethodSelector, formatVNDFull } from '@/components/vip';
import type { PaymentMethod } from '@/components/vip';
