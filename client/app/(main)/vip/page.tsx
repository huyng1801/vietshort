  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-8">
      <div className="relative overflow-hidden pb-8">
        <div className="relative max-w-4xl mx-auto px-4 pt-20 lg:pt-24">
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-8 -mt-4">
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-5 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-red-500/20 text-red-400 text-base font-bold flex items-center justify-center">1</span>
            Chọn loại VIP
          </h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-5 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-red-500/20 text-red-400 text-base font-bold flex items-center justify-center">2</span>
            Chọn thời hạn
          </h2>
          {loading ? (
        ...
        {selectedPlan && (
          <section>
            <h2 className="text-xl font-bold text-white mb-5 flex items-center gap-2">
              <span className="w-8 h-8 rounded-full bg-red-500/20 text-red-400 text-base font-bold flex items-center justify-center">3</span>
        ...
        {selectedPlan && paymentMethod && (
          <section className="sticky bottom-16 lg:bottom-4 z-30">
            <div className="rounded-2xl border border-white/10 bg-gray-900/95 backdrop-blur-lg p-5 sm:p-6 shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <div className="text-base text-gray-400">Gói đã chọn</div>
                  <div className="text-xl font-bold text-white">
                    {selectedTier === 'VIP_GOLD' ? 'VIP Gold' : 'VIP FreeAds'} - {selectedPlan.label}
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">{formatVNDFull(selectedPlan.price)}</div>
              ...
              <button
                ...
                disabled={processing}
                className="w-full py-4 text-base bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 rounded-xl text-white font-bold transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-red-500/20"
              >
                {processing ? (
                  <>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-5">So sánh các gói</h2>
          <div className="rounded-2xl border border-white/10 bg-gray-800/30 overflow-hidden">
        ...
        <section className="pb-4">
          <h2 className="text-xl font-bold text-white mb-5">Câu hỏi thường gặp</h2>
          <div className="space-y-3">
            {[
              ...
              <details key={item.q} className="group rounded-xl border border-white/10 bg-gray-800/30">
                <summary className="cursor-pointer px-5 py-4 text-base font-medium text-white flex items-center justify-between list-none">
                  {item.q}
                  <ChevronLeft className="w-5 h-5 text-gray-500 transition-transform -rotate-90 group-open:rotate-90" />
                </summary>
                <div className="px-5 pb-4 text-base text-gray-400 border-t border-white/10 pt-4">
                  {item.a}
                </div>
              </details>
            ))}
